...
/**
 * Chinese fallbacks are not optional: the UI is Chinese and none of the Latin
 * faces ahead of them carry CJK glyphs, so dropping them silently downgrades
 * every heading and body line to the browser default. Geist itself has no CJK
 * glyphs either, hence the same fallback chain as before, just appended after it.
 */
const FONT_FAMILY_SANS =
	'Geist, -apple-system, BlinkMacSystemFont, "Segoe UI", Helvetica, Arial, "PingFang SC", "Microsoft YaHei", sans-serif'
